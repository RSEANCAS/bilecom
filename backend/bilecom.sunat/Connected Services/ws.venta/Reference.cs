...
namespace bilecom.sunat.ws.venta {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://service.sunat.gob.pe", ConfigurationName="ws.venta.billService")]
    public interface billService {
        ...
        bilecom.sunat.ws.venta.getStatusResponse getStatus(bilecom.sunat.ws.venta.getStatusRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="urn:getStatus", ReplyAction="*")]
        System.Threading.Tasks.Task<bilecom.sunat.ws.venta.getStatusResponse> getStatusAsync(bilecom.sunat.ws.venta.getStatusRequest request);
        ...
        bilecom.sunat.ws.venta.sendBillResponse sendBill(bilecom.sunat.ws.venta.sendBillRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="urn:sendBill", ReplyAction="*")]
        System.Threading.Tasks.Task<bilecom.sunat.ws.venta.sendBillResponse> sendBillAsync(bilecom.sunat.ws.venta.sendBillRequest request);
        ...
        bilecom.sunat.ws.venta.sendPackResponse sendPack(bilecom.sunat.ws.venta.sendPackRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="urn:sendPack", ReplyAction="*")]
        System.Threading.Tasks.Task<bilecom.sunat.ws.venta.sendPackResponse> sendPackAsync(bilecom.sunat.ws.venta.sendPackRequest request);
        
        // CODEGEN: El parámetro 'ticket' requiere información adicional de esquema que no se puede capturar con el modo de parámetros. El atributo específico es 'System.Xml.Serialization.XmlElementAttribute'.
        [System.ServiceModel.OperationContractAttribute(Action="urn:sendSummary", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        [return: System.ServiceModel.MessageParameterAttribute(Name="ticket")]
        bilecom.sunat.ws.venta.sendSummaryResponse sendSummary(bilecom.sunat.ws.venta.sendSummaryRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="urn:sendSummary", ReplyAction="*")]
        System.Threading.Tasks.Task<bilecom.sunat.ws.venta.sendSummaryResponse> sendSummaryAsync(bilecom.sunat.ws.venta.sendSummaryRequest request);
    }
    ...
    public partial class getStatusResponse {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://service.sunat.gob.pe", Order=0)]
        [System.Xml.Serialization.XmlElementAttribute(Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public bilecom.sunat.ws.venta.statusResponse status;
        
        public getStatusResponse() {
        }
        
        public getStatusResponse(bilecom.sunat.ws.venta.statusResponse status) {
            this.status = status;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface billServiceChannel : bilecom.sunat.ws.venta.billService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class billServiceClient : System.ServiceModel.ClientBase<bilecom.sunat.ws.venta.billService>, bilecom.sunat.ws.venta.billService {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        bilecom.sunat.ws.venta.getStatusResponse bilecom.sunat.ws.venta.billService.getStatus(bilecom.sunat.ws.venta.getStatusRequest request) {
            return base.Channel.getStatus(request);
        }
        
        public bilecom.sunat.ws.venta.statusResponse getStatus(string ticket) {
            bilecom.sunat.ws.venta.getStatusRequest inValue = new bilecom.sunat.ws.venta.getStatusRequest();
            inValue.ticket = ticket;
            bilecom.sunat.ws.venta.getStatusResponse retVal = ((bilecom.sunat.ws.venta.billService)(this)).getStatus(inValue);
            return retVal.status;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<bilecom.sunat.ws.venta.getStatusResponse> bilecom.sunat.ws.venta.billService.getStatusAsync(bilecom.sunat.ws.venta.getStatusRequest request) {
            return base.Channel.getStatusAsync(request);
        }
        
        public System.Threading.Tasks.Task<bilecom.sunat.ws.venta.getStatusResponse> getStatusAsync(string ticket) {
            bilecom.sunat.ws.venta.getStatusRequest inValue = new bilecom.sunat.ws.venta.getStatusRequest();
            inValue.ticket = ticket;
            return ((bilecom.sunat.ws.venta.billService)(this)).getStatusAsync(inValue);
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        bilecom.sunat.ws.venta.sendSummaryResponse bilecom.sunat.ws.venta.billService.sendSummary(bilecom.sunat.ws.venta.sendSummaryRequest request) {
            return base.Channel.sendSummary(request);
        }
        
        public string sendSummary(string fileName, byte[] contentFile, string partyType) {
            bilecom.sunat.ws.venta.sendSummaryRequest inValue = new bilecom.sunat.ws.venta.sendSummaryRequest();
            inValue.fileName = fileName;
            inValue.contentFile = contentFile;
            inValue.partyType = partyType;
            bilecom.sunat.ws.venta.sendSummaryResponse retVal = ((bilecom.sunat.ws.venta.billService)(this)).sendSummary(inValue);
            return retVal.ticket;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<bilecom.sunat.ws.venta.sendSummaryResponse> bilecom.sunat.ws.venta.billService.sendSummaryAsync(bilecom.sunat.ws.venta.sendSummaryRequest request) {
            return base.Channel.sendSummaryAsync(request);
        }
        
        public System.Threading.Tasks.Task<bilecom.sunat.ws.venta.sendSummaryResponse> sendSummaryAsync(string fileName, byte[] contentFile, string partyType) {
            bilecom.sunat.ws.venta.sendSummaryRequest inValue = new bilecom.sunat.ws.venta.sendSummaryRequest();
            inValue.fileName = fileName;
            inValue.contentFile = contentFile;
            inValue.partyType = partyType;
            return ((bilecom.sunat.ws.venta.billService)(this)).sendSummaryAsync(inValue);
        }
    }
}
