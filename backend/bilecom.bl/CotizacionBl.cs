...
namespace bilecom.bl
{
    public class CotizacionBl : Conexion
    {
        ...
        public List<CotizacionBe> BuscarCotizacion(int empresaId, string nombresCompletosPersonal, string razonSocial, DateTime fechaHoraEmisionDesde, DateTime fechaHoraEmisionHasta, out int totalRegistros)
        {
            totalRegistros = 0;
            ...
            {
                cn.Open();
                lista = cotizacionDa.Buscar(empresaId, nombresCompletosPersonal, razonSocial, fechaHoraEmisionDesde, fechaHoraEmisionHasta, cn, out totalRegistros);
                cn.Close();
            }
