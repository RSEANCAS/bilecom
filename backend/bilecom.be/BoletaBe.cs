...
namespace bilecom.be
{
    public class BoletaBe : Base
    {
        ...
        public int[] ListaBoletaGuiaRemisionEliminados { get; set; }
        public List<BoletaGuiaRemisionBe> ListaBoletaGuiaRemision { get; set; }

        public List<KeyValuePair<int, string>> ListaBoletaDocumentoEliminados { get; set; }
        public List<BoletaDocumentoBe> ListaBoletaDocumento { get; set; }
        public string ListaBoletaOrdenCompraStr
        {
            get
            {
                if (ListaBoletaDocumento == null) return null;
                if (ListaBoletaDocumento.Count == 0) return null;

                return string.Join("", ListaBoletaDocumento.Select(x => x.SerieNroComprobante).ToArray());
            }
        }

        public int[] ListaBoletaDetalleEliminados { get; set; }
        public List<BoletaDetalleBe> ListaBoletaDetalle { get; set; }
    }
}
